...
case class TableUtils(sparkSession: SparkSession) {
  ...
  // whether or not to enable avro schema validation check in BootstrapInfo and Analyzer, default is true, if you only have offline use case, feel free to set it to false
