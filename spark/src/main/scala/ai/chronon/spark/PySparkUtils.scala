...
object PySparkUtils {
  ...
  /**
    ...
    */
  def getTimeRangeOptional(timeRange: TimeRange): Option[TimeRange] =
    if (timeRange == null) Option.empty[TimeRange] else Option(timeRange)
  ...
  /**
    ...
    * @return DataFrame
    */
  def runGroupBy(groupByConf: api.GroupBy,
                 endDate: String,
                 stepDays: Option[Int],
