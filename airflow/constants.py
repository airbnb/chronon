...
UPLOAD_SCHEDULE_KEY = "uploadSchedule"  # customJson key holding the cadence of the GroupBy upload job
DEFAULT_UPLOAD_SCHEDULE = "@daily"  # Cadence of the GroupBy upload job when `UPLOAD_SCHEDULE_KEY` is unset
