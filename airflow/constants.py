...
DEFAULT_UPLOAD_SCHEDULE = "@daily"  # Cadence of the GroupBy upload job when `uploadSchedule` is unset
UPLOAD_SCHEDULES = (DEFAULT_UPLOAD_SCHEDULE, "@weekly", "@monthly", "@quarterly")  # Supported `uploadSchedule` values
