...
#        return {}
#    overrides = {
#        "log4j:log4j": "@//third_party/java:log4j",
...
#
#    # For provided repos, we want to model the fact that we don't control the protobuf runtime version,
#    # for other repos override it with the rules_proto version.
#    if not repo.provided:
#        overrides.update({
#            "com.google.protobuf:protobuf-java": "@//third_party:protobuf-java",
#        })
#    return overrides
